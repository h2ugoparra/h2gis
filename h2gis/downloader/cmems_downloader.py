...
from h2gis import AppConfig
from h2gis.downloader.base import BaseDownloader
from h2gis.downloader.cmems_utils import CMEMSAPIError, get_dataset_time_range
from h2gis.downloader.commons import resolve_date_range
from h2gis.storage import split_time_range
from h2gis.types import DateLike, DateRange, DownloadTask, TimeResolution
...
def download_subset(
    ...
    *,
    ...
    Example:
        >>> from h2gis.downloader import cmems_download_subset
...
class CMEMSDownloader(BaseDownloader):
    ...
    def _write_manifest(self, tasks: list[DownloadTask], output_dir: Path) -> None:
        ...
        manifest_path = output_dir / "h2gis_manifest.json"
