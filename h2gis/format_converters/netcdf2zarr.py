...
from h2gis.processing.registry import PROCESSORS
from h2gis.storage.storage import write_append_zarr
from h2gis.storage.xarray_helpers import chunk_dataset, rename_dims
from h2gis.storage.zarr_catalog import ZarrCatalog
from h2gis.types import TimeResolution
from h2gis.utils.files_io import safe_move_files, safe_rmtree
...
class Netcdf2Zarr:
    ...
    def _read_manifest(self) -> list[dict]:
        ...
        manifest_path = self.download_root / "h2gis_manifest.json"
